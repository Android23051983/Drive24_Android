...
public class CarLandlordAdapter extends RecyclerView.Adapter<CarLandlordAdapter.ViewHolder>{
    private final LayoutInflater inflater;
    private final List<LandlordCars> cars;

    public CarLandlordAdapter(Context context, List<LandlordCars> cars) {
        this.cars = cars;
        this.inflater = LayoutInflater.from(context);
    }

    @Override
    public CarLandlordAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int vievType) {
        View view = inflater.inflate(R.layout.list_item, parent, false);
        return new CarLandlordAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CarLandlordAdapter.ViewHolder holder, int position) {
        LandlordCars car = cars.get(position);
